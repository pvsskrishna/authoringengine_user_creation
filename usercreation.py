...
for r in range(2, rows + 1):
    ...
    type = Select.select_by_visible_text("Cognito") #since we are selecting cognito , password textfiled will disappaer
    time.sleep(2)
    ...
    wrole = Select.select_by_visible_text("SAMPLE ROLE")  # given role as 'sample role'
    time.sleep(2)
